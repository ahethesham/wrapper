 ...
 */
class basic_http_request_interface : public basic_parser_interface<buffer_v1>{
    public:
         ...
         */
        virtual std::shared_ptr<basic_http_request_interface> clone() = 0;
        /*
         * implementations should have to take care of implementing these copy constrcutor
         */ 
        basic_http_request_interface(basic_http_request_interface &) = delete;
        basic_http_request_interface(basic_http_request_interface &&) = delete;
        basic_http_request_interface& operator=(basic_http_request_interface &) = delete;
        basic_http_request_interface& operator=(basic_http_request_interface &&) = delete;
        
        basic_http_request_interface() = default;
        virtual ~basic_http_request_interface() = default;
