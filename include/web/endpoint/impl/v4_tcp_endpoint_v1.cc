...
std::shared_ptr<basic_endpoint_interface::iterator_interface>  v4_tcp_endpoint_v1::begin(){
    return std::make_shared< iterator>(impl_->begin());
}
std::shared_ptr<basic_endpoint_interface::iterator_interface> v4_tcp_endpoint_v1::end(){
    return std::make_shared< iterator >(impl_->end());
}
