...
class http_response_v1 : public basic_http_response_interface{
    public:
        ...
        http_response_v1 & set_body(std::shared_ptr<basic_object_interface >body) override;


        // injections
        http_response_v1 & set_headers(std::shared_ptr<basic_http_headers_interface > headers) override;
        http_response_v1 & set_response_line(std::shared_ptr<basic_http_response_line_interface > response_line) override;
