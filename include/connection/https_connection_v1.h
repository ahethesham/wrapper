...
/*
 * initiate and make connection with the client
 */
class https_connection_v1 : public basic_connection_interface{
    public:
       ...
       std::shared_ptr<basic_http_response_interface> send(std::shared_ptr<basic_http_request_interface> req) override;
       // a connection cannot be movable or copyable or assignable
