...
local function my_on_attach(bufnr)
  ...
  vim.keymap.set("n", "<CR>", api.node.open.vertical, {buffer = bufnr})
end
...
-- Override the default fallback icon to '>'
...
-- Set fallback icon to '>' for any unrecognized file
devicons.set_default_icon('>', '#aaaaaa', 65)
EOF
