...
/*
 * scope based exit basically used when we are allocating 'dynamic memory
 */
struct scope_exit {
...
// we will be supporint dupliacate query parameters
...
inline socket_t create_client_socket(
  ...
  auto sock = create_socket(
      ...
      [&](socket_t sock2, struct addrinfo &ai, bool &quit) -> bool {
        ...
        // rest of the operations are blocking
...
inline bool ClientImpl::send_(Request &req, Response &res, Error &error) {
  {
    ...
    // releasing the mutex.
    // doesnot make any sense as this is a blocking IO and we are already using mutex
