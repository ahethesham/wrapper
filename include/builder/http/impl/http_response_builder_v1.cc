...
class http_response_builder_v1<T>::impl{
    ...
    public:
        impl(std::shared_ptr<basic_http_response_interface> obj)
        {
            ...
            response_->set_response_line(*new http_response_line_v1());
            response_->set_headers(*new http_headers_v1());
            response_->set_body(*new json_object());
        }
        impl(){
            response_ = std::make_shared<T>();
            response_->set_response_line(*new http_response_line_v1());
        ...
        //impl(std::shared_ptr<basic_http_response_interface > obj)
        //: response_(obj) {
        //    response_->set_body(*new json_object_v1());
        //    response_->set_header(*new http_headers_v1());
        //    response_->set_response_line(*new http_response_line_v1());
        //}
...
//clone
template<typename T>
std::shared_ptr<basic_response_builder_interface<T>> http_response_builder_v1<T>::clone(){
