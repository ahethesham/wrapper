...
class basic_http_response_interface : public basic_parser_interface<buffer_v1>{
    ...
    public:
        ...
        virtual basic_http_response_interface & set_body(std::shared_ptr<basic_object_interface  >body) = 0 ;
       
        // injections
        virtual basic_http_response_interface & set_headers(std::shared_ptr<basic_http_headers_interface > headers) = 0;
        virtual basic_http_response_interface & set_response_line(std::shared_ptr<basic_http_response_line_interface > response_line) = 0;
